...
| IMP-004 | CLOSED / PASS / ACCEPTANCE MET
| IMP-005 | IMPLEMENTED / CI_PASS / AWAITING_EVIDENCE_CLOSURE — commit `f89cad8`, run `30430862143` |
| IMP-005 | NOT_RUN |
...
Total governed files listed, excluding this manifest: **21**.

| # | File | Classification | SHA-256 |
|---:|---|---|---|
| 1 | `Nuwa_NWB_Engineering_Document_Set_README_v1.0.md` | REFERENCE / CURRENT | `3B57A4115B64001F7B921435620DD33943CACB32204F43EF6BCCEB660CE09D07` |
...
| 9 | `ADR-IMP-004_Deterministic_Fixture_Contract_v1.0.md` | DERIVED IMPLEMENTATION STANDARD / IMP-004 | `57E7CA3E2164606B23FAB04D7FB90FBBACA2493EDAB070FAB221C82AF306051D` |
| 10 | `ADR-IMP-005_Format_0x_Version_Policy_v1.0.md` | DERIVED IMPLEMENTATION STANDARD / IMP-005 | `0414F4DD18C218643A61E3B8036EBCCC79C48B9F0CBFA2DE61B31DD2CDA8A770` |
| 11 | `Nuwa_NWB_Traceability_Registry_v1.0.toml` | TRACEABILITY AUTHORITY | `E1580A26705C436380FC5E68782DAE6F5C1AA9B9180BC55103AF5BFDF87D274F` |
| 12 | `Nuwa_NWB_Requirements_Test_Traceability_Matrix_v1.0.md` | GENERATED REFERENCE | `4112AA00605679DC3E0D7468F45C6673C1D44E469B41D4BC228C495667BC3F89` |
| 13 | `Nuwa_NWB_Test_Result_Record_v1.3.md` | REFERENCE / CURRENT | `A50C041C8B21536943624E477CF730FA0ABB9CBADF6F58D4091AAB742BDA229C` |
| 14 | `IMP-000_EVD_Build_Evidence_v1.0.md` | REFERENCE / CURRENT FOR IMP-000 | `434F4107FB6A970A80C0A4DF4B9180048C3766EA74B4E3C4F1927F04A0A3E5D7` |
| 15 | `IMP-001_EVD_Test_Result_Evidence_v1.2.md` | REFERENCE / CURRENT FOR IMP-001 | `2A53BDB7750A3239AF8972C746F16154307DE488C7F3892AD8E6129B463F76B9` |
| 16 | `IMP-002_EVD_Requirements_Traceability_Evidence_v1.0.md` | REFERENCE / CURRENT FOR IMP-002 | `400CA0C59D29E0D0CE39AC35E48FE83F576AF9D64032E4E6455721C74D36D176` |
| 17 | `IMP-003_EVD_Structured_Diagnostics_Evidence_v1.0.md` | REFERENCE / CURRENT FOR IMP-003 | `1B3F7F8E6ED7C949F1607017B9A191B741BD36222E7550033AC4C93331F4B8B7` |
| 18 | `Nuwa_NWB_Test_Result_Record_v1.2.md` | HISTORICAL / SUPERSEDED | `2740E3D201DBDD0379085AB80D265C7016CD2A279BAF28E12C3FA4CE04C7AF8D` |
| 19 | `Nuwa_NWB_Test_Result_Record_v1.1.md` | HISTORICAL / SUPERSEDED | `CA413B23E6499BB72E5E7F4095CE95C37F4A0E4A801D940900508EA198F424DB` |
| 20 | `Nuwa_NWB_Test_Result_Record_v1.0.md` | HISTORICAL / SUPERSEDED / MALFORMED_SOURCE_RETAINED_FOR_TRACEABILITY | `854F5F7A51C226B8177FA57703AE8895D117294BAB3C4AF0AD2B657E99C1CCCE` |
| 21 | `IMP-001_EVD_Test_Result_Evidence_v1.0.md` | HISTORICAL / SUPERSEDED / MALFORMED_SOURCE_RETAINED_FOR_TRACEABILITY | `4CAC2A7802666EA45B81D1A63DDCA220CE0729F180F95DA86F295E2A00AB8396` |

## Verification Notes

- All 21 listed files exist; the manifest itself is excluded.
- All current artifacts are UTF-8/LF and contain no prohibited control bytes.
- Historical files #20 and #21 are deliberately retained byte-for-byte. Their hashes certify retained malformed sources, not current project truth.
