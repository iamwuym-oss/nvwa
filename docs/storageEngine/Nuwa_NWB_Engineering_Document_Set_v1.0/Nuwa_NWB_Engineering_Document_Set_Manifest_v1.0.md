...
| IMP-003 | IMPLEMENTED / PENDING_CI_AND_REVIEW — no acceptance claim |
| IMP-004–005 | NOT_RUN |
| Product release | NOT_APPROVED |

The current result record is Test Result Record v1.2. Current accepted work-package evidence is IMP-000 EVD v1.0, IMP-001 EVD v1.2 and IMP-002 EVD v1.0. IMP-003 evidence does not yet exist because CI, review and validation remain pending. Test Result Record v1.1 is historical/superseded; the malformed v1.0 records remain historical sources retained only for traceability.
...
Total governed files listed, excluding this manifest: **17**.

| # | File | Classification | SHA-256 |
|---:|---|---|---|
| 1 | `Nuwa_NWB_Engineering_Document_Set_README_v1.0.md` | REFERENCE / CURRENT | `81F14606EAD9DB36FBF6C24F563E98062E44459F2AF8BFD333267EAAFBD6FED7` |
...
| 8 | `Nuwa_NWB_Structured_Error_and_Logging_Specification_v1.0.md` | DERIVED IMPLEMENTATION STANDARD / IMP-003 | `4197A9E16AAA7CD02F956EB7C84505C1055244D152DA5DE1017F7DDBD6FD76AE` |
| 9 | `Nuwa_NWB_Traceability_Registry_v1.0.toml` | TRACEABILITY AUTHORITY | `1DFCC50997B6E0D5C21B3968533A23F0D0EB7A5C15070DA95399EF1D4E7D3E97` |
| 10 | `Nuwa_NWB_Requirements_Test_Traceability_Matrix_v1.0.md` | GENERATED REFERENCE | `9364F782DC471AA8740F3CC7DDA750C04E2804AA82C86E1A406A21F6FF92A531` |
| 11 | `Nuwa_NWB_Test_Result_Record_v1.2.md` | REFERENCE / CURRENT | `224A2DB6D5ECB8B796C33CEA3AF351BFAC1C350AF7A1DEBF7A2A52C8F81718F3` |
...
| 15 | `Nuwa_NWB_Test_Result_Record_v1.1.md` | HISTORICAL / SUPERSEDED | `CA413B23E6499BB72E5E7F4095CE95C37F4A0E4A801D940900508EA198F424DB` |
| 16 | `Nuwa_NWB_Test_Result_Record_v1.0.md` | HISTORICAL / SUPERSEDED / MALFORMED_SOURCE_RETAINED_FOR_TRACEABILITY | `854F5F7A51C226B8177FA57703AE8895D117294BAB3C4AF0AD2B657E99C1CCCE` |
| 17 | `IMP-001_EVD_Test_Result_Evidence_v1.0.md` | HISTORICAL / SUPERSEDED / MALFORMED_SOURCE_RETAINED_FOR_TRACEABILITY | `4CAC2A7802666EA45B81D1A63DDCA220CE0729F180F95DA86F295E2A00AB8396` |

## Verification Notes

- All 17 listed files exist; the manifest itself is excluded.
- All current artifacts are UTF-8/LF and contain no prohibited control bytes.
- Historical files #16 and #17 are deliberately retained byte-for-byte. Their hashes certify retained malformed sources, not current project truth.
- Test Result Record v1.1 is well-formed historical evidence but is superseded by v1.2.
- The latest accepted implementation evidence remains bound to IMP-002 commit `8b2a68b0528d37587636774eb76bc196b94dd59a` and CI run `29691731514`. IMP-003 has no tested-commit or run binding yet.
