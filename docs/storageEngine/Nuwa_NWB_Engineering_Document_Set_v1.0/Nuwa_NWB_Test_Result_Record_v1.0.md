...
**记录状态：** IN_PROGRESS
**说明：** IMP-000 evidence record has been corrected (IMP-000-EVIDENCE-CLOSURE-1-CORRECTION-1: Run ID, job IDs, toolchain, PM signoff). CLOSED / PASS / ACCEPTANCE MET (e1f1adb, CI run 29426443433, Windows job 87389958591, Ubuntu job 87389958600). CI toolchain: rustc/cargo 1.97.0; Local Windows: rustc/cargo 1.96.1. IMP-001 evidence remains in progress.
...
|---|---|
| 产品版本 | `0.1.0-dev` |
| NWB Format版本 | `0.x DRAFT`（IMP-001 Format Registry present; IMP-000 closed） |
| Git提交 | `e1f1adb`（IMP-000 CI证据绑定）；`ad6695b` + 未提交修改（原始IMP-001证据） |
...
| GATE-0.IMP-000 | 建立Workspace | CLOSED / PASS / ACCEPTANCE MET | 2026-07-15 | IMP-000_EVD_Build_Evidence_v1.0.md (e1f1adb, CI run 29426443433) | 已消除 | nwb_code_reviewer, nwb_validation_engineer, nwb_storage_project_manager |
