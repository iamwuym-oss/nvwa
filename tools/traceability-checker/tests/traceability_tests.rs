...
fn valid_registry_passes() {
    ...
    assert_eq!(report.requirements, 39);
    assert_eq!(report.tests, 155);
    assert_eq!(report.mappings, 158);
    assert_eq!(report.p0_requirements, 36);
    assert_eq!(report.planned_tests, 115);
    assert_eq!(report.implemented_tests, 40);
    assert_eq!(report.mapped_tests, 136);
